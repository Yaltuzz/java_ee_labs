...
public class Initialize {
    ...
    @Inject
    public Initialize(UserService userService,OfficeCenterService officeCenterService,OfficeService officeService,RequestContextController requestContextController) {
